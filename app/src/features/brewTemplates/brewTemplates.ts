...
export const brewTemplates: BrewTemplate[] = [
  ...
  core({
    id: 'iced-orea-flash', name: 'Orea Flash 冰手冲', category: 'daily-pourover', difficulty: 'easy', brewMode: 'iced_pourover', brewer: 'Orea 平底滤杯', filter: '平底滤纸', doseGrams: 15, waterGrams: 150, iceGrams: 75, ratio: '1:10', waterTemperatureC: { min: 92, max: 95 }, grindSize: '中细', targetTimeSeconds: { min: 105, max: 150 },
    pourSteps: [step(1, 0, 35, 45, '闷蒸', '下壶预置 75g 冰；热水注到 45g。'), step(2, 35, 75, 100, '主注水', '注热水到累计 100g。'), step(3, 75, 110, 150, '收尾', '注热水到 150g，滴滤后与 75g 冰充分摇匀。')], suitableFor: ['浅烘', '花香', '明亮', '夏季'], avoidFor: ['深烘'], flavorGoal: '快速降温并保留明亮香气和甜感。', adjustmentRules: ['成品偏淡时保持总量不变，减少冰量并增加热水。'], sourceNotes: '参考 Orea Flash Brew 指南：粉水比仅按 150g 热水计算，另用 75g 冰快速冷却。', sourceUrls: ['https://orea.uk/guides-v4'],
  }),
  core({
    id: 'iced-seven-miles-177', name: 'Seven Miles 1:7:7 冰手冲', category: 'daily-pourover', difficulty: 'easy', brewMode: 'iced_pourover', brewer: 'V60', filter: '锥形滤纸', doseGrams: 15, waterGrams: 105, iceGrams: 105, ratio: '1:7', waterTemperatureC: { min: 92, max: 95 }, grindSize: '中细', targetTimeSeconds: { min: 100, max: 145 },
    pourSteps: [step(1, 0, 35, 45, '闷蒸', '下壶预置 105g 冰；热水注到 45g。'), step(2, 35, 80, 105, '热水段', '继续注热水到 105g。'), step(3, 80, 110, 105, '冷却完成', '滴滤结束后与 105g 冰旋转混合至充分冷却。')], suitableFor: ['浅烘', '水果调', '高香气'], avoidFor: ['追求高浓度'], flavorGoal: '等量热水和冰快速冷却，得到轻盈清爽杯感。', adjustmentRules: ['冰未完全融化属正常；偏淡时将热水与冰改为 8:6。'], sourceNotes: '参考 Seven Miles 冰手冲 1:7:7 思路：粉水比按 105g 热水计算，另用 105g 冰冷却。', sourceUrls: ['https://www.sevenmiles.com.au/blogs/editorial/iced-coffee-tips'],
  }),
  core({
